...
const defaultNavigationLinks: Navbar01NavLink[] = [
  ...
  { href: '/settings/dockerfile-templates', label: '模版管理', active: false },
...
export const Navbar01 = React.forwardRef<HTMLElement, Navbar01Props>(
  (
    {
      className,
      logo = <img src="/xuanwu/logo.svg" alt="Logo" width='20' />,
      logoHref = '#',
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <span className="hidden font-bold text-xl sm:inline-block">玄武工厂</span>
              </button>
              {/* Navigation menu */}
              {!isMobile && (
