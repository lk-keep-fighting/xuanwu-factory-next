 ...
 * Dockerfile模版管理页面
 */
export default function DockerfileTemplatesPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">Dockerfile模版管理</h1>
          <p className="text-gray-600 mt-2">管理和维护Dockerfile构建模版</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="text-sm text-gray-600">前端模版</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
            ...
            <div className="text-sm text-gray-600">Java模版</div>
          </CardContent>
        </Card>
      </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    {template.id.includes('system') && (
                      <Badge variant="outline">系统模版</Badge>
                    )}
                  </div>
                </div>
              </div>
      ...
      {filteredTemplates.length === 0 && (
        <div className="text-center py-12">
          <div className="text-gray-500 text-lg">没有找到匹配的模版</div>
          <p className="text-gray-400 mt-2">尝试调整搜索条件或创建新模版</p>
        </div>
      )}
